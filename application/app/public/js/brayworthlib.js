...
var dlg=$('<div class="container" />');var form=$('<form class="form" />').appendTo(dlg);$('<div class="row" />').append($('<div class="col" />').append(flds.user)).appendTo(form);$('<div class="row" />').append($('<div class="col" />').append(flds.pass)).appendTo(form);function submitter(){var u=flds.user.val();var p=flds.pass.val();if(u.trim()==''){$('body').growlError('empty user');flds.user.focus();return}
